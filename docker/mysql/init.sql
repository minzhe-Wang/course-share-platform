...
('软件工程课程设计验收模板', '覆盖需求分析、类图、顺序图、Docker 部署和答辩讲解，可直接作为课程设计验收参考。', 5, '/api/files/download?fileKey=materials%2Fdemo-software-engineering.pdf', 'materials/demo-software-engineering.pdf', 'software-engineering-demo.pdf', 'PDF', 42896, 4, 'APPROVED', '词库审核通过', NOW(), 86, 18, 24, 16, 1, DATE_SUB(NOW(), INTERVAL 1 DAY)),
('数据库原理期末复习提纲', '整理 ER 图、范式、事务隔离级别、索引和 SQL 优化常见题型。', 4, '/api/files/download?fileKey=materials%2Fdemo-database-review.pdf', 'materials/demo-database-review.pdf', 'database-review.pdf', 'PDF', 38920, 3, 'APPROVED', '词库审核通过', NOW(), 64, 14, 17, 11, 1, DATE_SUB(NOW(), INTERVAL 2 DAY)),
('计算机网络实验指导合集', '包含 Socket 编程、HTTP 抓包、DNS 查询和 TCP 三次握手实验记录模板。', 2, '/api/files/download?fileKey=materials%2Fdemo-network-lab.docx', 'materials/demo-network-lab.docx', 'network-lab-guide.docx', 'DOCX', 51200, 4, 'APPROVED', '词库审核通过', NOW(), 51, 9, 12, 8, 1, DATE_SUB(NOW(), INTERVAL 3 DAY)),
('数据结构常见算法笔记', '覆盖链表、栈、队列、树、图、排序和动态规划的课堂笔记。', 3, '/api/files/download?fileKey=materials%2Fdemo-data-structure.pdf', 'materials/demo-data-structure.pdf', 'data-structure-notes.pdf', 'PDF', 35600, 5, 'APPROVED', '词库审核通过', NOW(), 73, 21, 19, 13, 1, DATE_SUB(NOW(), INTERVAL 4 DAY)),
('Java Web 项目脚手架示例', '一个适合课程实训的 Spring Boot + Vue 前后端分离项目结构示例。', 7, '/api/files/download?fileKey=materials%2Fdemo-java-web.zip', 'materials/demo-java-web.zip', 'java-web-starter.zip', 'ZIP', 102400, 5, 'APPROVED', '词库审核通过', NOW(), 58, 16, 13, 10, 1, DATE_SUB(NOW(), INTERVAL 5 DAY)),
('违规广告资料示例', '包含广告引流内容，应该被词库审核拒绝，不会出现在公开资料库。', 5, '/api/files/download?fileKey=materials%2Fdemo-rejected.pdf', 'materials/demo-rejected.pdf', 'rejected-demo.pdf', 'PDF', 12000, 3, 'REJECTED', '命中敏感词：广告', NOW(), 0, 0, 0, 0, 1, DATE_SUB(NOW(), INTERVAL 1 DAY));
